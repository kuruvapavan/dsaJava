...
//    }
//
//    private static boolean subsetSum(int[] nums, int i, int sum) {
//
//        if (sum==0){
//            return true;
...
//            return true;
//        }
//        return memo[i][sum]=subsetSum(nums,i+1,sum-nums[i]) || subsetSum(nums,i+1,sum);
//    }
//
////    private  static boolean recursion(int[] nums, int left, int target, int index) {
////        if (index >= nums.length) {
////
////            return target==left;
////        }
////        return recursion(nums,left+nums[index],target,index+1) ||
////                recursion(nums,left,target,index+1);
////
////    }
//}
